        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="text-center">
                    ...
                    <h4>Form Surat Keterangan Domisili</h4>
                    <!-- pencarian -->
                </div>
            </div>
                ...
                <form action="cetak_administrasi" method="POST">
                    ...
                    <div class="card mt-3">
                        <div class="card-header" style="background-color: #042165;">
                            <h3 class="card-title text-white">Pengajuan Surat Domisili</h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <button type="submit" name="cetak_domisili" class="btn btn-block btn-success float-right"><i class="fas fa-save"></i> Cetak</button>
                        </div>
                    </div>
                </form>
            </section>
