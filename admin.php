...
<div class="content-wrapper">
...
} else if (isset($_GET['views']) && $_GET['views'] == "data_anggota_kk") {
        include 'views/pages/data_anggota_kk.php';
    ...
    } else if (isset($_GET['views']) && $_GET['views'] == "data_klasifikasi_surat") {
        include 'views/pages/data_klasifikasi_surat.php';
