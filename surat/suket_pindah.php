...
<div style="border:1px solid #007bff; border-radius:5px; padding:15px; max-width:750px; font-family:Arial, sans-serif; margin:auto; margin-top:20px;">
    ...
    <form action="../report/cetak_pindah.php" method="post" enctype="multipart/form-data" target="_blank">
        <div style="margin-bottom:15px;">
            ...
            <select name="id_pend" id="id_pend" 
                style="width:300px; padding:5px; border:1px solid #ccc; border-radius:3px;" required>
                <option selected="selected">- Pilih Data -</option>
                <?php
                // Ambil data yang status = 'Pindah'
                $query = "SELECT NIK, NAMA_LGKP, TMPT_LHR, TGL_LHR FROM tabel_kependudukan ORDER BY NAMA_LGKP ASC";
