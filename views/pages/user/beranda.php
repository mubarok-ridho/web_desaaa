    ...
    <div class="container">
        <div class="row gy-4">
            <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                <h1>Pemerintah Desa Kaliputih</h1>
                <p style="text-align: justify;">
                    Sistem Pemerintah Desa kaliputih merupakan suatu sistem yang dapat mengolah data kependudukan yang berada di <?= $row_profil->nama_desa; ?> menjadi Data Klasifikasi kependudukan dan Data Klasifikasi Bantuan.
                </p>
                <div>
           ...
           <!-- <div class="col-lg-6 order-1 order-lg-2 hero-img">
            ...
            <div class="col-lg-6 order-1 order-lg-2 hero-img">
                <img src="<?= $base_url; ?>asset_user/img/Preloader.gif" class="img-fluid animated" alt="">
            </div>
